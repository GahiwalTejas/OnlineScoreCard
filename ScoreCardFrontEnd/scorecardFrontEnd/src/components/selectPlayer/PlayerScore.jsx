    ...
    //    className={` m-2  w-full ${className}`}
      ...
      onClick={() =>{
        ...
        <Button
          ...
          className="m-5 w-20"
        ></Button>
        <Button children={"W"} className="m-5 bg-red-600 w-20"></Button>
        <Button children={"B"} className="m-5 bg-green-600 w-20"></Button>
      </div>
      <Button
        children={"Next"}
      ...
      <Button
        children={"End Match"}
        className="m-15 float-center font-bold  bg-red-600 "
      ></Button>
